...
const BottomNavigation = ({ activeTab = 'home' }) => {
  ...
  const navItems = [
    ...
    { id: 'connections', icon: FiUsers, label: 'Connections', path: '/connections' },
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`group flex flex-col items-center space-y-1 p-2 rounded-xl transition-all duration-300 ${isActive
              ...
              >
                ...
                <span className={`text-xs transition-colors duration-300 ${isActive
                    ? 'text-cyan-500'
