...
import { PageLoader, EmptyState, ErrorState } from '../components/common/LoadingStates';
    ...
    if (loading && !stats) {
        return (
            <PageContainer maxWidth="max-w-7xl">
                <PageLoader message="Loading connections..." />
            </PageContainer>
        );
    }
        ...
        <PageContainer maxWidth="max-w-7xl">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    disabled={syncing}
                    className="flex items-center px-4 py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-300 disabled:opacity-50 shadow-lg hover:shadow-xl"
                >
                    <FiRefreshCw className={`w-4 h-4 mr-2 ${syncing ? 'animate-spin' : ''}`} />
                    <span className="hidden sm:inline">{syncing ? 'Syncing...' : 'Sync Google Data'}</span>
